...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
    ...
    <?php if(get_theme_mod('podcaster_radio_toggle_tags',true)==1){ ?>
    ...
    <?php } ?>
        ...
        if ( is_singular( 'attachment' ) ) {
            ...
            the_post_navigation( array(
                'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'podcaster-radio' ),
            ) );
        } elseif ( is_singular( 'post' ) ) {
            // Previous/next post navigation.
            the_post_navigation( array(
                'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'podcaster-radio' ) . '</span> ' .
                    '<span class="screen-reader-text">' . __( 'Next post:', 'podcaster-radio' ) . '</span> ' .
                    '<span class="post-title">%title</span>',
                'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'podcaster-radio' ) . '</span> ' .
                    '<span class="screen-reader-text">' . __( 'Previous post:', 'podcaster-radio' ) . '</span> ' .
                    '<span class="post-title">%title</span>',
            ) );
        }
    ?>
